    ...
    const fetchVendor = async () => {
      try {
        ...
        if (data?.data) {
          ...
          if (v.banner) setBannerPreview(v.banner);
        }
      } catch (err) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="h-24 w-full rounded-md bg-gray-100 border flex items-center justify-center overflow-hidden">
                    {bannerPreview ? (
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Recommended: wide image, max 2MB.
                    </p>
                  </div>
                </div>
              </div>
